...
The value of B1=`r round(B1,2)`, which represents the difference in mpg values between automatics and manuals at average weight,
is a little bigger than in our first model, but again has a small p value and therefore is not very significant.  However the value of B3=`r round(B3,2)` ,
which represents the difference in slopes between the two transmissions, is statistically significant with p=0.001.
And finally the effect of weight, B2=`r round(B2,2)` is negative and very significant.
...
Note that B2=`r round(B2,2)`, which represents the slope coefficient 
